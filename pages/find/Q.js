...
const subCategoryDescriptions = {
    '종교': '다양한 종교 활동을 통해 신앙을 나누고\n삶의 가르침을 배우는 분과입니다.',
    '봉사': '다양한 봉사 활동을 통해 사회에 기여하고\n나눔의 가치를 실천하는 분과입니다.',
    '정보과학': '정보 과학을 탐구하며\n여러 첨단 기술을 학습하고 응용하는 분과입니다.',
    '학술교양': '다양한 학문과 교양 지식을 탐구하며\n경험과 지적 성장을 추구하는 분과입니다.',
    '창작예술': '창의력을 통한 예술을 표현할 수 있는 분과입니다.',
    '문화': '다양한 문화 생활을 함께 즐기며\n추억을 쌓아가는 분과입니다.',
    '생활체육': '이색적인 스포츠를 일상 속에서\n함께 즐길 수 있는 분과입니다.',
    '음악연주': '서로 다른 악기로\n아름다운 화음을 만들어가는 분과입니다.',
    '공연예술': '수많은 연습으로 빛나는 무대를 만들어가는 분과입니다.',
    '구기체육': '같은 스포츠를 좋아하는 사람들과 함께\n열정을 나누는 분과입니다.',
